...
export const APP_CONFIG = {
  ...
  // 2. HÌNH ẢNH & NHẬN DIỆN (Thay link ảnh tại đây)
  assets: {
  ...
  // 4. NỘI DUNG 5 ĐIỀU KHOẢN HỢP ĐỒNG
  sections: {
    // Điều 01
    section1: {
  ...
  // 6. MÀN HÌNH THÀNH CÔNG (Sau khi ký)
  success: {
